...
describe("company Routes Test", function () {
  ...
  describe("GET /companies and query strings", function(){
    /* Get all companies, test the response and status code 200 */
    test("Get all companies with no query string", async function () {
